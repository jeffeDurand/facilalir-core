...
- **App**: [Facilalir/Facilalir.xcodeproj](Facilalir/Facilalir.xcodeproj) — SwiftUI, MVVM, `Info-additions.plist` merged with generated keys (no ATS exceptions; no networking code).
